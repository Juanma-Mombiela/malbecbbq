    ...
    <section id="about" className="bg-white py-10">
      <div className="container mx-auto flex flex-col md:flex-row items-start gap-6">
        <div className="w-1/3 h-full">
          <img src="/aboutus.jpg" alt="About Malbec BBQ" className="rounded-[12px] h-80" />
        </div>
        <div className="w-1/3">
        ...
        <div className="w-1/3">
          <img src="/logo_aboutus.svg" alt="About Malbec BBQ" className="h-64" />
        </div>
      </div>
      <div className="container mx-auto flex flex-col md:flex-row items-start gap-6">
        <div className="w-1/3 h-full">
          <img src="/icon_aboutus.svg" alt="About Malbec BBQ" className="h-48" />
        </div>
        <div className="w-1/3">
        ...
        <div className="w-1/3">
          <img src="/aboutus_two.jpg" alt="About Malbec BBQ" className="rounded-[12px] h-96"/>
        </div>
      </div>
    </section>
  );
