    ...
    <section id="catering" className="bg-white py-10">
      ...
      <div className="container mx-auto flex flex-col items-center text-center px-4 pt-8">
        ...
        <div className="relative w-full max-w-4xl">
          ...
          />
          {/* Navigation Arrows */}
          <button className="max-sm:hidden flex items-center justify-center absolute w-14 h-14 top-1/2 -left-7 transform -translate-y-1/2 bg-primary text-white rounded-[10px] p-2 shadow-md">
            <img src="/arrow-left.svg" alt="Arrow" className="w-8 h-8" />
          </button>
          <button className="max-sm:hidden flex items-center justify-center absolute w-14 h-14 top-1/2 -right-7 transform -translate-y-1/2 bg-primary text-white rounded-[10px] p-2 shadow-md">
